...
import { panelChildren } from "./Routers";

export function Panel() {
  const defaultState = useRef({
    emailFieldValue: "jaikrishnaverma@gamil.com",
    nameFieldValue: "Jr. Software Developer",
  });
    ...
    <Navigation location={location.pathname}>
      <Navigation.Section
        ...
        items={panelChildren
          ...
          .map((item) => {
            return {
              selected:"/panel/"+item.path===location.pathname,
